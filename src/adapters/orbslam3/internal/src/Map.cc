...
void Map::EraseKeyFrame(KeyFrame *pKF)
{
    ...
    // OA-SLAM: Remove keyframes from objects observations
    for (auto* obj : mspMapObjects) {
...
// OA-SLAM: MapObject storage methods
...
void Map::EraseMapObject(MapObject *pMO)
{
    ...
    // ObjectTrack is responsible for memory freeing
}

void Map::SetReferenceMapObjects(const std::vector<MapObject*>& vpMOs)
{
    unique_lock<mutex> lock(mMutexMap);
